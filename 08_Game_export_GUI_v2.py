...
class Game:
    def __init__(self, partner, stakes, starting_balance):
        ...
        # Help and Game export button (row 5)
        ...
        self.export_button = Button(self.help_export_frame, text="Game export...",
                                   font="Arial 15 bold",
                                   bg="#003366", fg="white")
        self.export_button.grid(row=5, column=1, padx=2)
    ...
    def reveal_boxes(self):
        ...
        for item in range(0, 3):
            ...
            prizes.append(prize)
            export_prizes.append(prize_list)
        ...
        round_summary = "{} | {} | {} - cost: ${} |" \
                        ...
                        "${}".format(export_prizes[0], export_prizes[1],
                                     export_prizes[2],
                                     5 * stakes_multiplier, round_winnings,
                                     current_balance)
        self.round_export_list.append(round_summary)
        print(self.round_export_list)
        ...
        if current_balance < 5 * stakes_multiplier:
            ...
            balance_statement = "current Balance: ${}\n" \
                                ...
                                "or view your export. Sorry about that.".format(current_balance)
